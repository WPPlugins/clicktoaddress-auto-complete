...
class WC_ClickToAddress_Autocomplete_Integration extends WC_Integration {
	...
	public function addJs($type, $dir){
		if($this->config->access_token != ''){
			printf("<script type='text/javascript'>var cc_c2a_config = %s;</script>",json_encode($this->config));
			wp_enqueue_script('clicktoaddress-autocomplete-js-core','https://cc-cdn.com/generic/scripts/v1/cc_c2a.min.js');
			wp_enqueue_script('clicktoaddress-autocomplete-js-'.$type,plugins_url( '../'.$dir.'/js/'.$type.'.js', __FILE__ ));
		}
	}
